 ...
 */
package com.alliander.osgp.adapter.protocol.iec61850.cls.infra.messaging;
...
public abstract class DeviceRequestMessageProcessor implements MessageProcessor {
    ...
    // LoggerFactory.getLogger(DeviceRequestMessageProcessor.class);
    //
    // @Autowired
    ...
    //
    // protected final static String UNEXPECTED_EXCEPTION = "Unexpected
    // exception while retrieving response message";
    //
    // /**
    ...
    // * process.
    // */
    // protected DeviceRequestMessageProcessor(final DeviceRequestMessageType
    // deviceRequestMessageType) {
    // this.deviceRequestMessageType = deviceRequestMessageType;
    // }
    //
    // /**
    // * Initialization function executed after dependency injection has
    // finished.
    ...
    // ex = new TechnicalException(ComponentType.PROTOCOL_IEC61850,
    ...
    // protected void handleGetStatusDeviceResponse(final DeviceResponse
    // deviceResponse,
    // final ResponseMessageSender responseMessageSender, final String domain,
    // final String domainVersion,
    // final String messageType, final int retryCount) {
    ...
    // }
    //
    // public void handleUnExpectedError(final DeviceResponse deviceResponse,
    // final Throwable t,
    // final Serializable messageData, final String domain, final String
    // domainVersion, final String messageType,
    // final boolean isScheduled, final int retryCount) {
    //
    // final ResponseMessageResultType result =
    // ResponseMessageResultType.NOT_OK;
    // final OsgpException ex = new
    // TechnicalException(ComponentType.PROTOCOL_IEC61850, t.getMessage());
    //
    // final ProtocolResponseMessage responseMessage = new
    // ProtocolResponseMessage(domain, domainVersion, messageType,
    // deviceResponse.getCorrelationUid(),
    ...
    // }
    //
    // protected void handleExpectedError(final OsgpException e, final String
    // correlationUid,
    // final String organisationIdentification, final String
    // deviceIdentification, final String domain,
    // final String domainVersion, final String messageType) {
    // LOGGER.error("Expected error while processing message", e);
    //
    // final ProtocolResponseMessage protocolResponseMessage = new
    // ProtocolResponseMessage(domain, domainVersion,
    // messageType, correlationUid, organisationIdentification,
