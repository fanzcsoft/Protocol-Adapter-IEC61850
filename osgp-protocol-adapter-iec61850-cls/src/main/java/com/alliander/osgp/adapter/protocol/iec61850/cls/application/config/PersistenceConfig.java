...
@EnableJpaRepositories(entityManagerFactoryRef = "entityManagerFactory", basePackageClasses = {
        PlatformCommunicationProfileRepository.class })
@Configuration
...
public class PersistenceConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws ClassNotFoundException {
        ...
        entityManagerFactoryBean.setPersistenceUnitName("OSGP_PROTOCOL_ADAPTER_IEC61850_CLS");
        ...
        jpaProperties.put(PROPERTY_NAME_HIBERNATE_HBM2DDL_AUTO,
                this.environment.getRequiredProperty(PROPERTY_NAME_HIBERNATE_HBM2DDL_AUTO));
