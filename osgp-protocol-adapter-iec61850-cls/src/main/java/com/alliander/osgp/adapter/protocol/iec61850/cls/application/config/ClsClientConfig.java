...
public class ClsClientConfig {
    ...
    // LoggerFactory.getLogger(ClsClientConfig.class);
    //
    // private static final String PROPERTY_NAME_IEC61850_TIMEOUT_CONNECT =
    // "iec61850.timeout.connect";
    // private static final String PROPERTY_NAME_IEC61850_PORT_CLIENT =
    // "iec61850.port.client";
    // private static final String PROPERTY_NAME_IEC61850_PORT_CLIENTLOCAL =
    // "iec61850.port.clientlocal";
    // private static final String PROPERTY_NAME_IEC61850_PORT_SERVER =
    // "iec61850.port.server";
    // private static final String PROPERTY_NAME_IEC61850_PORT_LISTENER =
    // "iec61850.port.listener";
    //
    // @Resource
    // private Environment environment;
    //
    // public ClsClientConfig() {
    ...
    // return
    // Integer.parseInt(this.environment.getProperty(PROPERTY_NAME_IEC61850_TIMEOUT_CONNECT));
    // }
    //
    // @Bean
    // public int iec61850PortClient() {
    // return
    // Integer.parseInt(this.environment.getProperty(PROPERTY_NAME_IEC61850_PORT_CLIENT));
    // }
    //
    // @Bean
    // public int iec61850PortClientLocal() {
    // return
    // Integer.parseInt(this.environment.getProperty(PROPERTY_NAME_IEC61850_PORT_CLIENTLOCAL));
    // }
    //
    // @Bean
    // public int iec61850PortServer() {
    // return
    // Integer.parseInt(this.environment.getProperty(PROPERTY_NAME_IEC61850_PORT_SERVER));
    // }
    //
    // /**
    ...
    // ClsClientConfig.this.createChannelPipeline(ClsClientConfig.this
    ...
    // }
    //
    // private ChannelPipeline createChannelPipeline(final ChannelHandler
    // handler) throws ProtocolAdapterException {
    // final ChannelPipeline pipeline = Channels.pipeline();
    //
    // pipeline.addLast("loggingHandler", new
    // LoggingHandler(InternalLogLevel.INFO, true));
    //
    // pipeline.addLast("iec61850RegisterDeviceRequestDecoder", new
    // RegisterDeviceRequestDecoder());
    //
    ...
    // return
    // Integer.parseInt(this.environment.getProperty(PROPERTY_NAME_IEC61850_PORT_LISTENER));
    // }
    //
    // /**
